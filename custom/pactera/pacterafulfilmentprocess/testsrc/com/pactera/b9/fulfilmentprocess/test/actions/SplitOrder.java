 ...
 */
package com.pactera.b9.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(PacteraFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PacteraFulfilmentProcessConstants.PARENT_PROCESS);
