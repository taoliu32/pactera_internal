...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pacterastorefront/electronics/en",
						"https://electronics.local:9002/pacterastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pacterastorefront/electronics/en",
						"https://electronics.local:9002/pacterastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pacterastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/pacterastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pacterastorefront/electronics/en",
						"https://electronics.local:9002/pacterastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pacterastorefront",
						"https://electronics.local:9002/pacterastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pacterastorefront",
						"https://electronics.local:9002/pacterastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/pacterastorefront/electronics/en",
						"https://electronics.local:9002/pacterastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
