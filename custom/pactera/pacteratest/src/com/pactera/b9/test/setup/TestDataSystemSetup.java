 ...
 */
package com.pactera.b9.test.setup;
...
import com.pactera.b9.test.constants.PacteraTestConstants;
import com.pactera.b9.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PacteraTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pacteratest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pacteratest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pacteratest/import/cstickets.impex");
			...
			importImpexFile(context, "/pacteratest/import/csquotes.impex");
		}
	}
}
