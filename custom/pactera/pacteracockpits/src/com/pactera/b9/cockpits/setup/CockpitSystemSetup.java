 ...
 */
package com.pactera.b9.cockpits.setup;
...
import com.pactera.b9.cockpits.constants.PacteraCockpitsConstants;
 ...
 */
@SystemSetup(extension = PacteraCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PacteraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PacteraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PacteraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/pacteracockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
