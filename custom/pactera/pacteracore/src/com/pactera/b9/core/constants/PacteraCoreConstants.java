 ...
 */
package com.pactera.b9.core.constants;

/**
 * Global class for all PacteraCore constants. You can add global constants for your extension into this class.
 */
public final class PacteraCoreConstants extends GeneratedPacteraCoreConstants
{
	public static final String EXTENSIONNAME = "pacteracore";


	private PacteraCoreConstants()
	{
		//empty
	}
